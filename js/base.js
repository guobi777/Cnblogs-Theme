function Base() {
            ...
            commentList.each(function (i) {
                ...
                if (p.length > 0) {
                    ...
                    if (op.length > 0 && op.text() != '') {
                        ...
                        var html = '<img class="comment-avatar" src="https://blog-static.cnblogs.com/files/guobi777/no_avatar.gif"/>';
                    }
    ...
    this.addFooter = function() {
        ...
        if (window.location.href.search("www.cnblogs.com/guobi777") == -1 ) {
            setTheme();
        }
        ...
        function setTheme() {
            ...
            setInterval(function(){
                var footer = $('#footer');
                var themeHtml = '<p id="ThemeAuthors" style="color: #444;z-index: 999;">- Theme Authors：<a href="https://www.cnblogs.com/guobi777/" target="_blank" style="color:#444;">国币</a> -</p></div>';
